...
const EN_TRANSLATIONS = {
    ...
    scanPromptRetake: "Tap the camera button to retake",
...
const TRANSLATIONS: Record<Language, Partial<Record<TranslationKey, string>>> = {
  ...
  es: {
    ...
    scanPromptRetake: "Toca el botón de cámara para volver a tomar",
  ...
  fr: {
    ...
    scanPromptRetake: "Appuyez sur le bouton caméra pour recommencer",
